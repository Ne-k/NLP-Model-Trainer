...
train_encodings = tokenizer([item[0] for item in train_data if isinstance(item[0], str)],
                            return_tensors='pt', padding=True,
                            truncation=True)
train_labels = tokenizer([item[1] for item in train_data if isinstance(item[1], str)],
                         return_tensors='pt', padding=True,
                         truncation=True)
