...
with tempfile.TemporaryDirectory() as temp_dir:
    train_encodings_file = tempfile.NamedTemporaryFile(mode='w+', dir=temp_dir, delete=False)
    train_labels_file = tempfile.NamedTemporaryFile(mode='w+', dir=temp_dir, delete=False)
    eval_encodings_file = tempfile.NamedTemporaryFile(mode='w+', dir=temp_dir, delete=False)
    eval_labels_file = tempfile.NamedTemporaryFile(mode='w+', dir=temp_dir, delete=False)
    ...
    train_encodings_file.close()
    train_labels_file.close()
    eval_encodings_file.close()
    eval_labels_file.close()

    os.unlink(train_encodings_file.name)
    os.unlink(train_labels_file.name)
    os.unlink(eval_encodings_file.name)
    os.unlink(eval_labels_file.name)